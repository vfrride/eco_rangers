...
class MarkersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create marker" do
    assert_difference('Marker.count') do
      post markers_url, params: { marker: { place_id: @marker.place_id, points: @marker.points, ranger_id: @marker.ranger_id } }
    end
  ...
  test "should update marker" do
    patch marker_url(@marker), params: { marker: { place_id: @marker.place_id, points: @marker.points, ranger_id: @marker.ranger_id } }
